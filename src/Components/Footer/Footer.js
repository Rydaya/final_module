        ...
        <footer className="footer">
            <div className="footer__description">
                ...
                <div className="footer__about">
                    ...
                    <div className="footer__text">Мы предоставляем возможность любому харьковчанину насладиться вкуснейшими суши, не выходя из дома. Не нужно проделывать долгий путь к заведению, достаточно зайти на сайт или позвонить нам по телефону, выбрать понравившиеся блюда и удобный способ оплаты заказа.</div>
                </div>
                <div className="footer__about">
            ...
            <div className="footer__contacts">
               <div className="footer__title">Давайте дружить</div>
